"""
Simple test for Phase 7: LangGraph Orchestration
Tests the orchestrator with detailed logging.
"""
import sys
import os
...
print("=" * 70)
print("Phase 7: Simple Orchestrator Test")
print("=" * 70)
print()
...
run = run_manager.create_run(
    prompt="Nike shoe advertisement",
    media_type="image",
...
print("   Workflow: Brand Kit → Generation → Critique → Refinement")
